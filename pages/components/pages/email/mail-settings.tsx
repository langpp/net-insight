                        ...
                        <div className="box">
                                        ...
                                        <div className="sm:p-4 p-0">
                                            ...
                                            <div className="mb-6 sm:flex items-center">
                                                ...
                                                <div className="inline-flex">
                                                    <button type="button" className="ti-btn-outline-primary text-white !rounded-e-none !font-medium ">Change</button>
                                                ...
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                    <input className="btn-check" type="radio" name="flexRadioDefault" id="flexRadioDefault1" />
                                                                    <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="flexRadioDefault1">Default radio</label>
                                                                    <input className="btn-check" type="radio" name="flexRadioDefault" id="flexRadioDefault2" defaultChecked />
                                                                    <label className="ti-btn !text-[0.75rem] !font-medium btn-sm ti-btn-outline-primary !rounded-s-none" htmlFor="flexRadioDefault2">Default checked radio</label>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div className="box-footer">
                                <div className="ltr:float-right rtl:float-left">
                                    ...
                                    <button type="button" className="ti-btn-outline-primary text-white m-1">
                                        Save Changes
                                    </button>
                                </div>
                            </div>
