                    ...
                    <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12" key={Math.random()}>
                        <div className="box product-card">
                            ...
                            <div className="box-footer text-center ">
                                <Link href="/components/pages/ecommerce/cart/" className="ti-btn ti-btn-primary m-2 !font-medium" onClick={() => { AddToCart(idx.id); }}><i className="ri-shopping-cart-2-line me-1 align-middle inline-block "></i>Move To Cart</Link>
                                <Link href="/components/pages/ecommerce/product-details/" className="ti-btn ti-btn-success m-2 !font-medium"><i className="ri-eye-line me-1 align-middle inline-block "></i>View Product</Link>
                            </div>
                        </div>
                    </div>
                )) : ""}
