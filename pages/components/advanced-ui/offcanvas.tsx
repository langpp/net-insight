            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode className="Live Demo" title="Live Demo" code={offcanvas1} customCardClass="custom-box">
                        ...
                        <div id="hs-overlay-example" className="hs-overlay hidden ti-offcanvas ti-offcanvas-left !z-[105]" >
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Body Scrolling" code={offcanvas2} customCardClass="custom-box">
                        ...
                        <div id="hs-overlay-body-scrolling" className="hs-overlay ti-offcanvas ti-offcanvas-left hidden [--body-scroll:true] [--overlay-backdrop:false] !z-[105]" >
                            <div className="ti-offcanvas-header">
                                <h6 className="ti-offcanvas-title">
                                    Notifications
                                </h6>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Enable Backdrop" code={offcanvas3} customCardClass="custom-box">
                        ...
                        <div id="hs-overlay-backdrop-default" className="hs-overlay ti-offcanvas ti-offcanvas-left hidden !z-[105]" >
                            <div className="ti-offcanvas-header">
                                <h6 className="ti-offcanvas-title">
                                    Notifications
                                </h6>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title=" Enable Body scrolling and backdrop" code={offcanvas5} customCardClass="custom-box">
                        ...
                        <div id="hs-overlay-backdrop-with-scrolling" className="hs-overlay ti-offcanvas ti-offcanvas-left hidden !z-[105] [--body-scroll:true]"  data-hs-overlay-scroll="true">
                            <div className="ti-offcanvas-header">
                                <h6 className="ti-offcanvas-title">
                                    Notifications
                                </h6>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Placements" code={offcanvas6} customCardClass="custom-box">
                        ...
                        <div id="hs-overlay-top" className="hs-overlay hidden ti-offcanvas ti-offcanvas-top !z-[105]" >
                            <div className="ti-offcanvas-header">
                        ...
                        <div id="hs-overlay-bottom" className="hs-overlay hidden ti-offcanvas ti-offcanvas-bottom !z-[105]" >
                            <div className="ti-offcanvas-header">
                                <h5 className="ti-offcanvas-title">
                                    Offcanvas title
                                </h5>
