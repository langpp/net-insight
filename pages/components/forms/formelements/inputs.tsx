...
const Inputs = () => {
    return (
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                        <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Overview" code={input9} customCardHeaderClass=" justify-between">
                                    <form>
                                        <div className="mb-3">
                        ...
                        <div className="xl:col-span-6 col-span-12">
                            <div className="grid grid-cols-12">
                                <div className="xl:col-span-12 col-span-12">
                                    <Showcode title="Form Text" code={input10} customCardHeaderClass=" justify-between">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <Showcode title="Inline text can use any typical inline HTML element with nothing more than the <span className=text-danger>.form-text</span> class." code={input12} customCardHeaderClass=" justify-between">
                        ...
                        <div className="xl:col-span-6 col-span-12">
                            <Showcode title="Disabled Forms"  code={input11} customCardHeaderClass=" justify-between">
                                    <form>
                                        <fieldset disabled>
