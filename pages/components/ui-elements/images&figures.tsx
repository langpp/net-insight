                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Responsive Image" code={image1}>
                        ...
                        <div className="text-center">
                            <Image src="../../../assets/images/media/media-48.jpg" className="img-fluid !inline-flex" alt="..." />
                        </div>
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image With Radius" code={image2}>
                        ...
                        <div className="text-center">
                            <Image src="../../../assets/images/media/media-49.jpg" className="img-fluid !rounded-md !inline-flex" alt="..." />
                        </div>
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Rounded Image" code={image3}>
                        ...
                        <div className="text-center">
                            <Image src="../../../assets/images/media/media-50.jpg" className="img-fluid !rounded-full !inline-flex" alt="..." />
                        </div>
                    </Showcode>
                </div>
            </div>
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Left Align" code={image4}>
                        <Image className="!rounded-md float-start" src="../../../assets/images/media/media-53.jpg" alt="..." />
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Center Align" code={image5}>
                        <Image className="!rounded-md mx-auto block" src="../../../assets/images/media/media-55.jpg" alt="..." />
                    </Showcode>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Image Right Align" code={image6}>
                        <Image className="!rounded-md ltr:float-right rtl:float-left" src="../../../assets/images/media/media-54.jpg" alt="..." />
                    </Showcode>
                </div>
            </div>
            <div className="grid grid-cols-12 gap-6">
                    ...
                    <Showcode title="Figures" code={image7}>
                        <div className="flex justify-between gap-2">
                            <figure className="figure inline-block mb-4">
                                <Image className="m-[0.125rem] leading-none img-fluid rounded-md w-full" src="../../../assets/images/media/media-56.jpg" alt="..." />
                            ...
                            <figure className="figure ltr:float-right rtl:float-left">
                                <Image className="m-[0.125rem] leading-none img-fluid rounded-md w-full" src="../../../assets/images/media/media-57.jpg" alt="..." />
