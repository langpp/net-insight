                            ...
                            <div className="box !bg-white dark:!bg-bodybg !border-0">
                                <div className="alert custom-alert1 alert-primary !bg-white dark:!bg-bodybg" id="dismiss-alert69">
                                    ...
                                    <div className="text-center px-[3rem] pb-0">
                                        ...
                                        <div className="">
                                            <button type="button" className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-outline-danger m-2">Decline</button>
                                            <button type="button" className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium bg-primary text-white m-2">Accept</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box bg-white border-0">
                                <div className="alert custom-alert1 alert-warning" id="dismiss-alert71">
                                    ...
                                    <div className="text-center px-5 pb-0">
                                        ...
                                        <div className="">
                                            <button type="button"
                                                className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-outline-secondary m-2">Back</button>
                                            <button type="button"
                                                className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium bg-warning text-white m-2">Continue</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
