        ...
        <div>
            ...
            <div className="grid grid-cols-12 md:gap-x-6">
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        <Image src="../../../assets/images/media/media-22.jpg" className="card-img-top" alt="..." />
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        <Image src="../../../assets/images/media/media-23.jpg" className="card-img-top" alt="..." />
                        <div className="box-body">
                            <p className="card-text">Some quick example text to build on the card title and
                                make up the bulk of the card content.</p>
                        </div>
                    </div>
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        <Image src="../../../assets/images/media/media-24.jpg" className="card-img-top" alt="..." />
                        <div className="box-body">
                            <h6 className="box-title font-semibold !text-[1rem]">Card title</h6>
                            <p className="card-text">Some quick example text to build on the card title and
                                make up the bulk of the card content.</p>
                ...
                <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-12 col-span-12">
                    ...
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <Image src="../../../assets/images/media/media-25.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <Image src="../../../assets/images/media/media-26.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <Image src="../../../assets/images/media/media-27.jpg" className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                ...
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <Image src="../../../assets/images/faces/15.jpg" alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-center">
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <Image src="../../../assets/images/faces/3.jpg" alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-end">
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <Image src="../../../assets/images/faces/11.jpg" alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
                    ...
                    <div className="box border border-success mb-4">
                        ...
                        <div className="box-body text-success">
                            ...
                            <p className="card-text">If you are going to use a passage of Lorem Ipsum, you need
                                to be sure there isnt anything embarrassing hidden in the middle of text.
            ...
            <div className="grid grid-cols-12 md:gap-x-6">
                    ...
                    <div className="box">
                        <div className="box-header">
                            <div className="flex align-center w-full">
                                <Image src="../../../assets/images/faces/11.jpg" alt="img" className="avatar avatar-rounded me-2 !mb-0" />
                        ...
                        <div className="box-body">
                            If you are going to use, you need to be sure there isnt anything embarrassing hidden in
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <Image src="../../../assets/images/media/media-4.jpg" className="card-img mb-4 !rounded-md"
                                alt="..." />
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <Image src="../../../assets/images/media/media-9.jpg" className="card-img mb-4 !rounded-md"
                                alt="..." />
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <Image src="../../../assets/images/media/media-15.jpg" className="card-img mb-4 !rounded-md"
                                alt="..." />
            ...
            <div className="grid grid-cols-12 md:gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <Image src="../../../assets/images/media/media-29.jpg" className="card-img-top" alt="..." />
                        <div className="box-body">
                            <h6 className="box-title font-semibold !text-[1rem]">Image caps are widely used in Blog
                            </h6>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        ...
                        <Image src="../../../assets/images/media/media-28.jpg" className="!rounded-b-md"
                            alt="..." />
                    </div>
                </div>
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        ...
                        <Image src="../../../assets/images/media/media-30.jpg" className="card-img rounded-0" alt="..." />
                        <div className="box-body">
                            <p className="card-text mb-0"><small>Last updated 3 mins
                                ago</small></p>
                        </div>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <div className="box-header">
                            <div className="box-title">Image caps are widely used in Blog</div>
                        </div>
                        <div className="box-body">
                            <p className="card-text mb-1 text-[#8c9097] dark:text-white/50">This is a wider card with supporting text below
                                as
                        ...
                        <Image src="../../../assets/images/media/media-31.jpg" className="card-img rounded-0" alt="..." />
                        <div className="box-footer">
                            <p className="card-text mb-0"><small>Last updated 3 mins
                                ago</small></p>
                        </div>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <Image src="../../../assets/images/media/media-32.jpg" className="card-img-top" alt="..." />
                        <div className="box-header">
                            <div className="box-title">Image caps are widely used in Blog</div>
                        </div>
                        <div className="box-body">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        ...
                        <Image src="../../../assets/images/media/media-33.jpg" className="!rounded-b-md"
                            alt="..." />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 col-span-12">
                    <div className="box overlay-card">
                        <Image src="../../../assets/images/media/media-35.jpg" className="card-img" alt="..." />
                        <div className="card-img-overlay flex flex-column p-0">
                            ...
                            <div className="box-body text-white">
                                <div className="card-text mb-2 !text-white">There are many variations of passages of
                                    ...
                                    by injected humour, or randomised words which dont look even.</div>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box overlay-card">
                        <Image src="../../../assets/images/media/media-36.jpg" className="card-img" alt="..." />
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box overlay-card">
                        <Image src="../../../assets/images/media/media-34.jpg" className="card-img" alt="..." />
                        <div className="card-img-overlay flex flex-column p-0">
                            <div className="box-header">
                                <div className="box-title !text-white">
                                    Image Overlays Are Awesome!
                            ...
                            <div className="box-body text-white">
                                <div className="card-text !text-white">There are many variations of passages of Lorem
                                    ...
                                    injected humour, or randomised words which dont look even.</div>
                            </div>
                    ...
                    <div className="box">
                        <div className="grid grid-cols-12 gap-0">
                            <div className="md:col-span-4 col-span-12">
                                <Image src="../../../assets/images/media/media-37.jpg"
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <div className="grid grid-cols-12 gap-0">
                            ...
                            <div className="md:col-span-4 col-span-12">
                                <Image src="../../../assets/images/media/media-38.jpg"
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        <div className="grid grid-cols-12 gap-0">
                            ...
                            <div className="md:col-span-4 col-span-12">
                                <Image src="../../../assets/images/media/media-39.jpg"
                                    className="img-fluid !rounded-e-md h-full w-full" alt="..." />
                            </div>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xxl:col-span-3 xl:col-span-6 col-span-12">
                    <div className="box">
                        <Link aria-label="anchor" href="#!" className="card-anchor"></Link>
                        <Image src="../../../assets/images/media/media-47.jpg" className="card-img-top" alt="..." />
                        <div className="box-body">
                            ...
                            <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be
                                sure there isnt anything embarrassing hidden in the middle of text.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {Gridcards.map((idx) => (
                    ...
                    <div className="col" key={Math.random()}>
                        <div className="box">
                            <Image src={idx.src} className="card-img-top" alt="..." />
                            <div className="box-body">
