    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar Sizes <p class='subtitle text-muted fs-12 font-normal'>Avatars of different sizes</p>" code={avatar2}>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Stacked Avatar <p class='subtitle text-muted fs-12 font-normal'>Group of avatars stacked together.</p>" code={avatar8}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Rounded Stacked Avatarsv <p class='subtitle text-muted fs-12 font-normal'>Group of avatars stacked together.</p>" code={avatar9}>
                            <div className="avatar-list-stacked">
                            {StackedAvatars.map((idx)=>(
