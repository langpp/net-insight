                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="xxl:col-span-8 col-span-12">
                        ...
                        <div>
                            ...
                            <Swiper breakpoints={breakpoints} slidesPerView={2} spaceBetween={30} centeredSlides={false}  modules={[Autoplay]} className="mySwiper" autoplay={{ delay: 2500, disableOnInteraction: false, }} >
