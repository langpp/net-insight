                            ...
                            <div className="box">
                                <div className="box-body">
                                    ...
                                    <div className=" text-center">
                                        <Link href="/components/pages/profile/" className="ti-btn ti-btn-primary !me-[0.65rem] !font-medium !py-1 !px-2 !text-[0.75rem]">
                                            Edit Profile
                                        </Link>
                                    ...
                                    <ul className="list-none personal-favourite-contacts mb-0">
                                        <li>
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <Link aria-label="anchor" href="#!" className="text-danger me-3"><i className="bi bi-heart-fill"></i></Link>
                                                    <div className="hs-dropdown ti-dropdown">
                                                        <Link aria-label="anchor" href="#!"
