import { Salesoverview, Salevalue, Trendingorders, WorldMap } from '@/shared/data/dashboards/salesdata'
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12">
                                <div className="col-span-6 pe-0">
                                    ...
                                    <Link href="#!" className="text-[0.75rem] mb-0 text-primary">Show full stats<i className="ti ti-chevron-right ms-1 inline-flex"></i></Link>
                                </div>
                            ...
                            <div className="tab-menu-heading border-0 p-0 ms-auto sm:mt-0 mt-2">
                                <div className="tabs-menu-task me-3">
                                    <nav className="" aria-label="Tabs">
                                        <Link href="#!" className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-secondary active" id="active-item" data-hs-tab="#Active" aria-controls="Active">
                                            Active Tasks
                                        </Link>
                                        <Link href="#!" className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-secondary " id="Complete-item" data-hs-tab="#Complete" aria-controls="Complete">
                                            Completed Tasks
                                        </Link>
                                    </nav>
                                </div>
