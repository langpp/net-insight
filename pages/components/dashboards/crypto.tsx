                            ...
                            <div className="box">
                                ...
                                <div className="box-body crypto-data">
                                    <nav className="tab-style-1 sm:flex bg-light p-[0.65rem] rounded-sm mb-4" aria-label="Tabs">
                                        <Link href="#!" className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-sm font-medium text-center rounded-md hover:text-primary active" id="buy-crypto" data-hs-tab="#buy-crypto2" >
                                            Buy
                                        </Link>
                                        <Link href="#!" className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 text-sm flex-grow font-medium text-center  rounded-md hover:text-primary " id="sell-crypto" data-hs-tab="#sell-crypto2" >
                                            Sell
                                        </Link>
                                    </nav>
