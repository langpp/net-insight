                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <table className="table whitespace-nowrap table-hover border table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            <th scope="row" className="ps-6"><input className="form-check-input" type="checkbox" value="" aria-label="..." /></th>
                                    ...
                                    <tbody>
                                        {Data.map((idx) => (
                                            <tr className="border hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10 border-defaultborder !border-x-0" key={Math.random()}>
                                                <th scope="row" className="ps-6"><input className="form-check-input" type="checkbox"  defaultChecked={idx.checked === 'defaultChecked'} value="" aria-label="..." /></th>
                                                <td>
