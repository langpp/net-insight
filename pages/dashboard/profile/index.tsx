...
const Profile = () => {
    return (
        <Fragment>
            <Seo title={"Profile"} />
            <Pageheader currentpage="Dashboard" activepage="Pages" mainpage="Profile" />
                        ...
                        <div className="box-body !p-0">
                            <div className="sm:flex items-start p-6      main-profile-cover">
                                <div>
                                    <span className="avatar avatar-xxl avatar-rounded online me-4">
                                        <Image src="/assets/images/faces/9.jpg" alt="" width={50} height={50} />
                                    </span>
                                </div>
                            ...
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10">
                                ...
                                <div className="mb-0">
                                    ...
                                    <div className="mb-0">
                                        <p className="mb-1">
                                            <Link href="https://www.spruko.com/" className="text-primary"><u>https://www.spruko.com/</u></Link>
                                        </p>
                                        <p className="mb-0">
                                            <Link href="https://themeforest.net/user/spruko/portfolio" className="text-primary"><u>https://themeforest.net/user/ spruko/portfolio</u></Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box">
                                <div className="box-body !p-0">
                                    <div className="!p-4 border-b dark:border-defaultborder/10 border-dashed md:flex items-center justify-between">
                                        ...
                                        <div>
                                            <p className="font-semibold mb-2">Profile 60% completed - <Link href="#!" className="text-primary text-[0.75rem]">Finish now</Link></p>
                                            ...
                                            <div className="tab-pane show active fade !p-0 !border-0" id="activity-tab-pane"
                                                ...
                                                <ul className="list-none profile-timeline">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="profile-activity-media mb-0 flex w-full mt-2 sm:mt-0">
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-17.jpg" alt="" width={50}
                                                                    height={50}/>
                                                                </Link>
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-18.jpg" alt="" width={50}
                                                                    height={50}/>
                                                                </Link>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div>
                                                            ...
                                                            <p className="profile-activity-media mb-0 flex w-full mt-2 sm:mt-0 items-center">
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/file-manager/3.png" alt="" width={50}
                                                                    height={50} />
                                                                </Link>
                                                    ...
                                                    <li>
                                                        <div>
                                                            ...
                                                            <p className="profile-activity-media mb-4">
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-75.jpg" alt="" width={50} height={50} />
                                                                </Link>
                                                            </p>
                                                            <div>
                                                                <div className="avatar-list-stacked">
                                                                    <span className="avatar avatar-sm avatar-rounded">
                                                                        <Image src="/assets/images/faces/2.jpg" alt="img" width={50} height={50} />
                                                                    </span>
                                                                    <span className="avatar avatar-sm avatar-rounded">
                                                                        <Image src="/assets/images/faces/8.jpg" alt="img" width={50} height={50} />
                                                                    </span>
                                                                    <span className="avatar avatar-sm avatar-rounded">
                                                                        <Image src="/assets/images/faces/2.jpg" alt="img" width={50} height={50} />
                                                                    </span>
                                                                    <span className="avatar avatar-sm avatar-rounded">
                                                                        <Image src="/assets/images/faces/10.jpg" alt="img" width={50} height={50} />
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div>
                                                            <span className="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                                <Image src="/assets/images/faces/5.jpg" alt="" width={50} height={50} />
                                                            </span>
                                                            ...
                                                            <p className="profile-activity-media sm:flex mb-0">
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-59.jpg" className="m-1" alt="" width={50} height={50} />
                                                                </Link>
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-60.jpg" className="m-1" alt="" width={50} height={50} />
                                                                </Link>
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-61.jpg" className="m-1" alt="" width={50} height={50} />
                                                                </Link>
                                                            </p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div>
                                                            <span className="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                                <Image src="/assets/images/media/media-39.jpg" alt="" width={50} height={50} />
                                                            </span>
                                                            <p className="mb-1">
                                                            ...
                                                            <p className="profile-activity-media mb-0 flex w-full mt-2 sm:mt-0">
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-26.jpg" alt="" width={50} height={50} />
                                                                </Link>
                                                                <Link aria-label="anchor" href="#!">
                                                                    <Image src="/assets/images/media/media-29.jpg" alt="" width={50} height={50} />
                                                                </Link>
                                                            </p>
                                                        </div>
                                                    </li>
                                                                                ...
                                                                                <div>
                                                                                    <Link aria-label="anchor" href="#!">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <Image src="/assets/images/media/media-52.jpg" alt="" width={50} height={50} />
                                                                                        </span>
                                                                                    </Link>
                                                                                    <Link aria-label="anchor" href="#!">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <Image src="/assets/images/media/media-56.jpg" alt="" width={50} height={50} />
                                                                                        </span>
                                                                                    </Link>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div className="rounded border dark:border-defaultborder/10">
                                                                    <div className="p-4 flex items-start flex-wrap">
                                                                        ...
                                                                        <div className="flex-grow">
                                                                            ...
                                                                            <div className="flex leading-none justify-between mb-4">
                                                                                <div>
                                                                                    <Link aria-label="anchor" href="#!">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <Image src="/assets/images/media/media-40.jpg" alt="" className="rounded-md" width={50} height={50} />
                                                                                        </span>
                                                                                    </Link>
                                                                                    <Link aria-label="anchor" href="#!">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <Image src="/assets/images/media/media-45.jpg" alt="" className="rounded-md" width={50} height={50} />
                                                                                        </span>
                                                                                    </Link>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div className="avatar-list-stacked block mt-4 text-end">
                                                                                <span className="avatar avatar-xs avatar-rounded">
                                                                                    <Image src="/assets/images/faces/1.jpg" alt="img" width={50} height={50} />
                                                                                </span>
                                                                                <span className="avatar avatar-xs avatar-rounded">
                                                                                    <Image src="/assets/images/faces/5.jpg" alt="img" width={50} height={50} />
                                                                                </span>
                                                                                <span className="avatar avatar-xs avatar-rounded">
                                                                                    <Image src="/assets/images/faces/16.jpg" alt="img" width={50} height={50} />
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div className="box-body p-6">
                                                                <div className="text-center">
                                                                    <span className="avatar avatar-xl avatar-rounded">
                                                                        <Image src={idx.src} alt="" width={50} height={50} />
                                                                    </span>
                                                                    <div className="mt-2">
                                            ...
                                            <Link href="#!">
                                                <div className="flex flex-wrap items-center">
                                                    <span className="avatar avatar-md me-4 !mb-0">
                                                        <Image src={idx.src} className="img-fluid !rounded-md" alt="..." width={50} height={50} />
                                                    </span>
                                                    <div className="flex-grow">
