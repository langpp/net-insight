...
export const LightboxGallery = () => {
  ...
  <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-40.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-41.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-42.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-43.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-44.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-45.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-46.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-60.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-26.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-32.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-30.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
                 <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-6 col-span-12">
                     <Link href="#!" className="glightbox card" data-gallery="gallery1">
                         <Image src={"../../../assets/images/media/media-31.jpg"} alt="image" width={50} height={50} className="rounded-sm" onClick={() => setOpen(true)} />
                     </Link>
                 </div>
